<template>
  <div class="w-full transition-colors duration-300" style="color: var(--color-text)">
    ...
    <div class="max-w-3xl rounded-md shadow overflow-hidden transition-colors duration-300"
      ...
      <form @submit.prevent="store">
        <div class="flex flex-wrap -mb-8 -mr-6 p-8">
          ...
          <file-input v-model="form.photo" :error="form.errors.photo"
                      class="pb-8 pr-6 w-full lg:w-1/2"
                      type="file"
                      accept="image/*"
                      label="Photo"
        ...
        <div class="flex items-center justify-end px-8 py-4 border-t transition-colors duration-300"
