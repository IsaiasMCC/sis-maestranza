    ...
    <div class="flex items-center justify-between mb-6">
      <search-filter v-model="form.search" class="mr-4 w-full max-w-md" @reset="reset">
        ...
        <input v-model="form.search" type="text"
               class="form-input mt-1 w-full transition-colors duration-300"
      ...
      <table class="w-full whitespace-nowrap transition-colors duration-300">
        ...
        <tbody>
          <tr v-for="reserva in reservas.data" :key="reserva.id"
            ...
            <td class="px-6 py-4">
              <Link :href="`/inf513/grupo10sc/proyecto2/sis-maestranza/public/mis-reservas-empleado/detalle/${reserva.id}`"
            ...
            <td class="px-6 py-4">
              <Link :href="`/inf513/grupo10sc/proyecto2/sis-maestranza/public/reservas/${reserva.id}`"
