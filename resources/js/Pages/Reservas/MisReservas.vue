    ...
    <div class="bg-white rounded-md shadow overflow-x-auto">
      <table class="w-full whitespace-nowrap">
        ...
        <tr v-for="reserva in reservas.data" :key="reserva.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          ...
          <td class="border-t">
            <Link class="flex items-center px-6 py-4" :href="`/mis-reservas/detalle/${reserva.id}`" tabindex="-1">
            {{ reserva.fecha }}
            </Link>
          </td>
          <td class="border-t">
          ...
          <td class="w-px border-t">
            <Link class="flex items-center px-4" :href="`/mis-reservas/detalle/${reserva.id}`" tabindex="-1">
